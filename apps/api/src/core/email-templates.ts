...
export const EmailTemplates = {
  ...
  getTeamInviteHtml: (params: {
    ...
    <head>
      <meta charset="utf-8">
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <title>Team Invitation - KnotEngine</title>
      <style>
        @import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700&display=swap');
        :root { color-scheme: dark; supported-color-schemes: dark; }
        @media only screen and (max-width: 600px) {
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" class="card" style="max-width: 440px; background-color: #0c0c0c; border: 1px solid #1a1a1a; border-radius: 20px; overflow: hidden;">
              ...
              <tr>
                <td align="center" style="padding: 0 32px 32px 32px; text-align: center;">
                  ...
                  <p style="color: #888888; font-size: 15px; line-height: 1.5; margin: 0 0 24px 0;">
                    <strong>${params.invitedBy}</strong> has invited you to join<br/>
                    <strong>${params.merchantName}</strong> on KnotEngine.
                  </p>

                  <!-- Role Badge -->
                  <div style="background-color: #1a1a1a; border: 1px solid #6366f1; border-radius: 12px; padding: 16px; margin-bottom: 24px;">
                    <div style="font-size: 12px; color: #666666; margin-bottom: 8px;">Your Role</div>
                    <div style="font-size: 18px; font-weight: 700; color: #6366f1; text-transform: capitalize;">
                      ${params.role}
                    </div>
                  </div>
                  ...
                  <!-- CTA Button -->
                  <div style="margin-bottom: 24px;">
                    <a href="${params.dashboardUrl}/login" class="button" style="display: inline-block; background-color: #6366f1; color: #ffffff; padding: 14px 28px; border-radius: 10px; text-decoration: none; font-weight: 700; font-size: 14px; letter-spacing: -0.01em;">
                      Accept Invitation
                    </a>
                  </div>
                  ...
                  <p style="color: #666666; font-size: 12px; line-height: 1.6; margin: 0;">
                    ...
                    If you didn't expect this invitation, safely ignore this email.
                  </p>
                </td>
              </tr>
